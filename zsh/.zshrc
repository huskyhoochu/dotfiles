...
alias yt-wall='f() { yt-dlp -f "bestvideo[height<=2160]+bestaudio/best" --merge-output-format mp4 -o "$HOME/Videos/Hidamari/%(title)s.mp4" "https://www.youtube.com/watch?v=$1"; }; f'
