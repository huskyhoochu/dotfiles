---
name: tsdoc
description: "Add TSDoc comments to exported symbols across the project. By default scans uncommitted/untracked files; use --all to scan the entire codebase. Use when the user asks to document or add comments to .ts/.tsx code — including bare 'add comments', 'document this', or 'JSDoc'. Also triggers on /tsdoc."
user-invocable: true
